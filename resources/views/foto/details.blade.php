      ...
      <section class="flex w-full bg-slate-200">
        <section class="flex flex-col">
          ...
          <section class="flex flex-col px-4 py-8">
            ...
            <hr x-show="showCommentThread" x-cloak class="border-y border-y-slate-300" />
            <section x-show="showCommentThread" x-cloak class="flex flex-col gap-3 px-3 py-5">
              <article
                href="#"
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <input type="hidden" name="userid" value="{{ $foto["UserID"] }}">
                    <section class="flex flex-col">
                      <textarea
                        name="isikomentar"
                        id="isikomentar"
              ...
              @foreach ($komentarfoto as $komentar)
                <article x-show="showCommentThread" x-cloak class="bg-slate-100 px-4 py-2 duration-200 hover:bg-slate-50">
                  <h4
