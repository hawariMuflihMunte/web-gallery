<input
  ...
  @switch($type)
    ...
    @default
      {{ $attributes->class(["font-barlow rounded-md border-[3px] border-slate-300 px-2 py-1 text-slate-600 outline-none focus-within:border-emerald-400 hover:border-emerald-400 focus:border-emerald-400 focus-visible:border-emerald-400 duration-300"]) }}
      @break
  @endswitch
