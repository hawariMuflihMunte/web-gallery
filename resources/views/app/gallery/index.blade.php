...
@section("content")
    ...
    <main class="min-h-[100vh] min-w-full py-28">
        ...
        <section class="mx-auto max-w-[96%] md:max-w-[90%] xl:max-w-[85%]">
            ...
            <section
                role="group"
                class="lg:scrollbar-w-2 lg:scrollbar-track-rounded lg:scrollbar-thumb-rounded lg:scrollbar-color-emerald-400 lg:scrollbar-thumb-emerald-400 grid max-h-[60vh] grid-cols-1 gap-5 overflow-y-scroll sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4"
            >
